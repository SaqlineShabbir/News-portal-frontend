...
const LatestArtiDetails = () => {
  ...
  const [searchParams] = useSearchParams();
    ...
    return (
        ...
        <div  className=''>
            <img  className='w-screen h-[80vh]' src={data?.avatar} alt="" />
            <div className='flex justify-center items-center'>
               <div>
               <p className='text-4xl relative bottom-[360px] px-10 font-bold'>{data?.title}</p>
               <p>{data?.date}</p>
               </div>
            </div>
        </div>
        ...
        <div className='w-[100%]  lg:flex  lg:px-[200px]  px-10'>
            <div className="left  lg:w-[60%] ">
                ...
                <div>
                    <p>{data?.description} We woke reasonably late following the feast and free
...
<br/> where we were visiting the Rila Monastery where we enjoyed
 scrambled eggs, toast, mekitsi, local jam and peppermint tea.</p>
                ...
                <img className='lg:w-full h-[400px] my-10' src={data?.avatar} alt="" />
